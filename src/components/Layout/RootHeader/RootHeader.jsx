    ...
    return (
        <header className={headerstyles.mainHeader}>
            <nav className={headerstyles.headerNav}>
                <div className={headerstyles.logoAndLocation}>

                    <a href="/" className={headerstyles.logo} title="Swiggy">
                    ...
                    <div className={headerstyles.locationDropdown}>
                        <button className={headerstyles.locationText}>
                            other
                        </button>
